 <!-- Sidebar menu-->
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        <li>
          <a class="app-menu__item active" href="index-2"
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <a class="treeview-item" href="boot"
            ...
            <li>
              <a class="treeview-item" href="ui"
                ><i class="icon fa fa-circle-o"></i> Cards</a
              >
            </li>
            <li>
              <a class="treeview-item" href="wdg"
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <a class="treeview-item" href="table"
                ><i class="icon fa fa-circle-o"></i> Basic Tables</a
              >
            </li>
            <li>
              <a class="treeview-item" href="tabledata"><i class="icon fa fa-circle-o"></i> Data Tables</a>
            </li>
          </ul>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <a class="treeview-item" href="blank"
            ...
            <li>
              <a class="treeview-item" href="page-lock"
            ...
            <li>
              <a class="treeview-item" href="page-cal"
                ><i class="icon fa fa-circle-o"></i> Calendar Page</a
              >
            </li>
            <li>
              <a class="treeview-item" href="page-mail"
